...
export const ENTERPRISE_CATALOG_DATA: EnterpriseCatalogItem[] = [
  ...
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', '2XL'],
    cta: 'Request Bulk Corporate Quote',
