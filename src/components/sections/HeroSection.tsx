...
const HERO_SLIDES = [
  {
    ...
    subheading:
      "Premium custom apparel and uniforms crafted for businesses, institutions, teams, and events—with quality, precision, and professional branding.",
  ...
  },
  {
    ...
    subheading:
      "From corporate and office wear to industrial, hospitality, school, and college uniforms—designed to strengthen your organization's identity.",
    shortDescription:
      "Professional uniform solutions for your corporate identity.",
  ...
  },
  {
    ...
    subheading:
      "Discover quality ready-stock polos, crew necks, and hoodies—premium fabrics, modern styles, and reliable quality for everyday wear.",
...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section
      className="relative min-h-0 lg:h-screen w-full flex items-center overflow-hidden bg-white pt-[72px] sm:pt-[88px] lg:pt-[69px] select-none"
    ...
    >
      ...
      <div className="w-full px-4 sm:px-10 lg:px-16 xl:px-20 relative z-20 h-auto lg:h-full flex items-center py-2 sm:py-4 lg:py-0">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h1 className="text-[26px] xs:text-[28px] sm:text-[34px] md:text-[48px] lg:text-[56px] xl:text-[68px] font-poppins font-extrabold text-[#0A2540] tracking-[-0.02em] md:tracking-[-0.03em] lg:tracking-[-0.03em] xl:tracking-[-0.04em] leading-[1.1] sm:leading-[1.08] md:leading-[1.08] lg:leading-[1.05] xl:leading-[1.05] max-w-full md:max-w-[560px] lg:max-w-[640px] xl:max-w-[740px] mt-4 sm:mt-6 lg:mt-8">
                  {HERO_SLIDES[currentSlide].headingPrefix}{" "}
                      ...
                      return (
                        ...
                        >
                          <motion.img
                            ...
                            onMouseEnter={() =>
                              idx === 1 && setIsHoveredSlide2(true)
                            }
                            onMouseLeave={() =>
                              idx === 1 && setIsHoveredSlide2(false)
                            }
                            onTouchStart={() =>
                              idx === 1 && setIsHoveredSlide2(true)
                            }
                ...
                <div className="flex flex-row items-center justify-start gap-x-1.5 xs:gap-x-2 sm:gap-x-3 md:gap-x-4 text-[8px] xs:text-[10px] sm:text-xs md:text-sm xl:text-[15px] text-[#6B5B60] font-poppins font-bold mt-[20px] md:mt-[22px] lg:mt-[24px] whitespace-nowrap w-full overflow-x-hidden">
                  ...
                  <span className="text-[#80011F]/30 font-light select-none shrink-0">
                    •
                  </span>
                  <div className="flex items-center gap-0.5 xs:gap-1 sm:gap-1.5 shrink-0">
