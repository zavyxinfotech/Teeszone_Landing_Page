...
export const TestimonialsSection: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="py-20 lg:py-28 bg-transparent relative" aria-label="Client Testimonials">
      <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-20">
        ...
        {/* Featured Testimonial Carousel Box (Borderless Premium Glass) */}
        <div className="max-w-4xl mx-auto stripe-card rounded-3xl p-8 sm:p-12 shadow-2xl bg-white/90 backdrop-blur-xl relative">
          <Quote className="absolute top-6 right-8 w-16 h-16 text-slate-200 pointer-events-none opacity-60" />
          ...
          <div className="space-y-6 relative z-10 font-inter">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="flex items-center gap-2 text-xs font-bold text-emerald-700 bg-emerald-50 px-3 py-1.5 rounded-full shadow-2xs">
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-3 rounded-2xl bg-white hover:bg-[#635BFF] hover:text-white text-[#0A2540] transition-colors cursor-pointer shadow-sm"
