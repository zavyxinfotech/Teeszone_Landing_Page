      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#1E3A5F]">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            {/* Social Links */}
            <div className="flex items-center gap-3 pt-2 font-poppins">
              {[
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            {newsletterSuccess ? (
              ...
              <form onSubmit={handleNewsletter} className="flex gap-2 pt-1 font-inter">
                ...
                <button
                  type="submit"
                  className="px-3.5 py-2.5 bg-[#635BFF] hover:bg-[#574BFF] text-white rounded-2xl transition-colors cursor-pointer"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-300 font-inter">
          <div className="flex flex-wrap items-center gap-3">
            <span>© {new Date().getFullYear()} {BRAND.name} Inc. All rights reserved.</span>
          ...
          <div className="flex flex-wrap items-center gap-6 text-xs text-slate-300">
            ...
            <a href="#" className="hover:text-white transition-colors">Pantone Guarantee</a>
